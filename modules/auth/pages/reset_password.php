...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(app_name()); ?> - <?php echo e(auth_lang('reset_title')); ?></title>
...
<div class="page page-center">
    <div class="container container-tight py-4">
        ...
        <form
            class="card card-md"
            action="<?php echo base_url('auth/actions/reset-password'); ?>"
            method="post"
            data-ajax="true"
            autocomplete="off"
            novalidate
        >
            <div class="card-body">
                ...
                <h2 class="card-title text-center mb-4"><?php echo e(auth_lang('reset_heading')); ?></h2>

                <?php if ($token === ''): ?>
                    <div class="alert alert-warning mb-4">
                        <?php echo e(auth_lang('reset_token_missing')); ?>
                    </div>
                <?php endif; ?>

                <div class="mb-3">
                    <label class="form-label"><?php echo e(auth_lang('reset_password')); ?></label>
                    <input type="password" name="password" class="form-control" minlength="6" required>
                </div>

                <div class="mb-3">
                    <label class="form-label"><?php echo e(auth_lang('reset_password_confirm')); ?></label>
                    <input type="password" name="password_confirm" class="form-control" minlength="6" required>
                </div>

                <div class="form-footer">
                    <button type="submit" class="btn btn-primary w-100" <?php echo $token === '' ? 'disabled' : ''; ?>>
                        <?php echo e(auth_lang('reset_submit')); ?>
                    </button>
                </div>
            </div>
        </form>
